    ...
    >
      <div className="max-w-[1360px] mx-auto px-5 md:px-8">
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-white/10">
          ...
          <div>
            <p className="font-bold text-sm uppercase tracking-wider text-bgold-light/70 mb-4">{t("footer.h_social")}</p>
            <div className="flex items-center gap-2.5 flex-wrap">
              <a
                ...
                className="w-10 h-10 rounded-full flex items-center justify-center shrink-0 bg-white/8 border border-bgold-light/25 text-bgold-light hover:bg-bgold hover:text-ink hover:border-bgold transition-colors"
              >
              ...
              <WeChatPopover
                triggerClassName="w-10 h-10 rounded-full flex items-center justify-center shrink-0 bg-white/8 border border-bgold-light/25 text-bgold-light hover:bg-bgold hover:text-ink hover:border-bgold transition-colors"
                iconSize={16}
              />
            </div>
          </div>

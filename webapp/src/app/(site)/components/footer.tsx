          ...
          <div>
            ...
            <div className="flex items-center gap-2 flex-nowrap">
              <a
                ...
                className="w-9 h-9 rounded-full flex items-center justify-center shrink-0 bg-white/8 border border-bgold-light/25 text-bgold-light hover:bg-bgold hover:text-ink hover:border-bgold transition-colors"
              >
              ...
              <WeChatPopover
                triggerClassName="w-9 h-9 rounded-full flex items-center justify-center shrink-0 bg-white/8 border border-bgold-light/25 text-bgold-light hover:bg-bgold hover:text-ink hover:border-bgold transition-colors"
                iconSize={16}
              />
            </div>
          </div>
